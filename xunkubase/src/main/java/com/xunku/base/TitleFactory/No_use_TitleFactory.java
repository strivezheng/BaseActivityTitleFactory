 ...
 * 封装了我们项目里面基本要用到的 title，画一次后，以后直接调用，一劳永逸。
 */

public class No_use_TitleFactory {
    ...
    private static No_use_TitleFactory instance;
    ...
    private No_use_TitleFactory(){}
    public static No_use_TitleFactory getInstance(){
        if(instance == null){
            instance = new No_use_TitleFactory();
        }
        return instance;
    }
    ...
    //样式 1 2
    ///////////////////////////////////////////////////////////////////////////
    //这个方法包含了style1和style2
    private View getStyle1(){
...
//        tv_right1.setText(rightString);
    ...
    public static class Builder{
         ...
         * @return
         */
        public No_use_TitleFactory build(){
            No_use_TitleFactory titleFactory= No_use_TitleFactory.getInstance();
         ...
         * @param titleFactory
         */
        private void apply(No_use_TitleFactory titleFactory){
